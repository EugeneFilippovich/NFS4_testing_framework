...
class TestCase2(main_cases.MainCases):
    #TODO comment
    ...
    @staticmethod
    def run_test_case():
        TestCase2.logger.info(constants.Constants.INFO_RENAME + constants.Constants.INFO_READ_WRITE_PROPERTY)
        ...
        assertion.Assertion.assert_ssh_to_server(step_1, TestCase2, 1)

        step_2 = main_cases.MainCases.change_folder(constants.Constants.CLIENT_SHARE_PATH)
        assertion.Assertion.assert_change_folder(step_2, TestCase2, 2)
        assertion.Assertion.assert_working_dir(TestCase2)

        step_3 = main_cases.MainCases.rename_file(constants.Constants.FILE_NAME, constants.Constants.FILE_NAME2)
        assertion.Assertion.assert_rename_file(step_3, TestCase2, 3)
        assertion.Assertion.assert_list_of_files(TestCase2)
